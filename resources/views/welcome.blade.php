            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="make" required name="make"
                               v-model="newCar.make">
                    </div>
                    <div class="form-group">
                        ...
                        <table class="table" id="table">
                            ...
                            <tr v-for="car in cars">
                                ...
                                <td class="text-center">
                                    <a class="btn btn-info" @click="setVal(car.id, car.make, car.model)"
                                    ...
                                    <a @click.prevent="deleteCar(car)" class="btn btn-danger">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            Brand: <input type="text" class="form-control" id="e_make" name="make"
                                         required :value="this.e_make">
                            Model: <input type="text" class="form-control" id="e_model" name="model"
                                          required :value="this.e_model">
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" @click="editCar()" data-dismiss="modal">Save
                                changes
                            </button>
